...
from cfa.dataops.datasets.scenarios.schemas.covid19_vax_coverage_adult import (
    extract_schema,
    load_schema,
    raw_synth_data,
    tf_synth_data,
)
from cfa.dataops.etl.scenarios.covid19_vax_coverage_adult import (
    transform,
)
...
def test_covid19_vax_coverage_adult_transform():
