...
raw_synth_data = raw_synth_data.assign(
    ...
    date_range_of_specimen=[
        gen_date_range(fake.date_between(start_date="-2y", end_date="today"))
    ...
    catchment_area_description=[
        random.choice(area_opts) for _ in range(df_len)
    ],
    ...
    ci_flag_5_11_prevalence=[random.choice([0.0, 1.0]) for _ in range(df_len)],
    ...
    ci_flag_12_17_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    ...
    ci_flag_65_prevalence=[random.choice([0.0, 1.0]) for _ in range(df_len)],
    ...
    lower_ci_cumulative_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_cumulative_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_cumulative_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    ...
    ci_flag_male_prevalence=[random.choice([0.0, 1.0]) for _ in range(df_len)],
    ...
    lower_ci_male_0_17_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_male_0_17_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_male_0_17_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    ...
    lower_ci_female_0_17_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_female_0_17_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_female_0_17_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_0_4_years_prevalence_=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_0_4_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_0_4_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_0_4_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_0_4_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_5_11_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_5_11_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_5_11_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_5_11_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_5_11_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_0_11_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_0_11_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_0_11_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_0_11_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_0_11_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_12_17_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_12_17_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_12_17_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_12_17_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_12_17_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_0_17_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_0_17_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_0_17_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_0_17_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_0_17_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_male_0_17_prevalence_rounds_31_and_later=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_anti_s_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_anti_s_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_anti_s_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_anti_s_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_anti_s_female_0_17_prevalence_rounds_31_and_later=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_0_4_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_0_4_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_0_4_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_0_4_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_0_4_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_5_11_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_5_11_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_5_11_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_5_11_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_5_11_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_0_11_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_0_11_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_0_11_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_0_11_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_0_11_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_12_17_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_12_17_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_12_17_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_12_17_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_12_17_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_0_17_years_prevalence=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_0_17_years_prevalence=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_0_17_years_prevalence=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_0_17_years_prevalence=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_0_17_years_prevalence=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_male_0_17_prevalence_rounds_31_and_later=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_male_0_17_prevalence_rounds_31_and_later=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    n_combined_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 100) for _ in range(df_len)
    ],
    rate_combined_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 1) for _ in range(df_len)
    ],
    lower_ci_combined_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(0, 50) for _ in range(df_len)
    ],
    upper_ci_combined_female_0_17_prevalence_rounds_31_and_later=[
        random.uniform(50, 100) for _ in range(df_len)
    ],
    ci_flag_combined_female_0_17_prevalence_rounds_31_and_later=[
        random.choice([0.0, 1.0]) for _ in range(df_len)
    ],
    cases_reported_by_date_of_last_specimen_collection=[
        random.uniform(0, 1000) for _ in range(df_len)
    ],
    estimated_cumulative_infections_all_count=[
        random.uniform(0, 10000) for _ in range(df_len)
    ],
    estimated_cumulative_infections_all_lower_ci=[
        random.uniform(0, 5000) for _ in range(df_len)
    ],
    estimated_cumulative_infections_all_upper_ci=[
        random.uniform(5000, 10000) for _ in range(df_len)
    ],
    estimated_reported_ratio=[random.uniform(0, 1) for _ in range(df_len)],
    estimated_reported_lower_ci=[
        random.uniform(0, 0.5) for _ in range(df_len)
    ],
    estimated_reported_upper_ci=[
        random.uniform(0.5, 1) for _ in range(df_len)
    ],
    estimated_cumulative_infections_0_17_count=[
        random.uniform(0, 5000) for _ in range(df_len)
    ],
    estimated_cumulative_infections_0_17_lower_ci=[
        random.uniform(0, 2500) for _ in range(df_len)
    ],
    estimated_cumulative_infections_0_17_upper_ci=[
        random.uniform(2500, 5000) for _ in range(df_len)
    ],
    all_age_sex_strata_had_at_least_one_positive=[
        random.choice([True, False]) for _ in range(df_len)
    ],
    all_age_sex_strata_had_at_least_one_negative=[
        random.choice([True, False]) for _ in range(df_len)
    ],
