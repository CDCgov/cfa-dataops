...
extract_schema = pa.DataFrameSchema({
    ...
    'lower_ci_anti_s_0_4_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_anti_s_0_4_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_anti_s_5_11_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_anti_s_5_11_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_anti_s_5_11_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_anti_s_0_11_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_anti_s_0_11_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_anti_s_0_11_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_anti_s_12_17_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_anti_s_12_17_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_anti_s_12_17_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_anti_s_0_17_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_anti_s_0_17_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_anti_s_0_17_years_prevalence': pa.Column(float, nullable = True),
    'n_anti_s_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'rate_anti_s_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'lower_ci_anti_s_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'upper_ci_anti_s_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'ci_flag_anti_s_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'n_anti_s_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'rate_anti_s_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'lower_ci_anti_s_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'upper_ci_anti_s_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'ci_flag_anti_s_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    ...
    'lower_ci_combined_0_4_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_combined_0_4_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_combined_0_4_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_combined_5_11_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_combined_5_11_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_combined_5_11_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_combined_0_11_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_combined_0_11_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_combined_0_11_years_prevalence': pa.Column(float, nullable = True),
    'n_combined_12_17_years_prevalence': pa.Column(float, nullable = True),
    'rate_combined_12_17_years_prevalence': pa.Column(float, nullable = True),
    'lower_ci_combined_12_17_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_combined_12_17_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_combined_12_17_years_prevalence': pa.Column(float, nullable = True),
    ...
    'lower_ci_combined_0_17_years_prevalence': pa.Column(float, nullable = True),
    'upper_ci_combined_0_17_years_prevalence': pa.Column(float, nullable = True),
    'ci_flag_combined_0_17_years_prevalence': pa.Column(float, nullable = True),
    'n_combined_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'rate_combined_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'lower_ci_combined_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'upper_ci_combined_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'ci_flag_combined_male_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'n_combined_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'rate_combined_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'lower_ci_combined_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'upper_ci_combined_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'ci_flag_combined_female_0_17_prevalence_rounds_31_and_later': pa.Column(float, nullable = True),
    'cases_reported_by_date_of_last_specimen_collection': pa.Column(float, nullable = True),
    'estimated_cumulative_infections_all_count': pa.Column(float, nullable = True),
    'estimated_cumulative_infections_all_lower_ci': pa.Column(float, nullable = True),
    'estimated_cumulative_infections_all_upper_ci': pa.Column(float, nullable = True),
    ...
    'estimated_cumulative_infections_0_17_count': pa.Column(float, nullable = True),
    'estimated_cumulative_infections_0_17_lower_ci': pa.Column(float, nullable = True),
    'estimated_cumulative_infections_0_17_upper_ci': pa.Column(float, nullable = True),
    'all_age_sex_strata_had_at_least_one_positive': pa.Column(bool, nullable = True),
    'all_age_sex_strata_had_at_least_one_negative': pa.Column(bool, nullable = True),
