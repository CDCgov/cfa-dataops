"""For ETL of the 2022-2023 Nationwide Blood Donor Seroprevalence Data"""
...
# import schema
from ...datasets.scenarios.schemas.donor_seroprevalence_2022 import (
    extract_schema,
    load_schema,
)
from ..utils import get_timestamp, transform_template_lookup

config = datacat.scenarios.donor_seroprevalence_2022
