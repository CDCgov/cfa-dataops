"""For ETL of the 2020-2021 Nationwide Blood Donor Seroprevalence Data"""
...
# import schema
from ...datasets.scenarios.schemas.donor_seroprevalence_2020 import (
    extract_schema,
    load_schema,
)
from ..utils import get_timestamp, transform_template_lookup

config = datacat.scenarios.donor_seroprevalence_2020
