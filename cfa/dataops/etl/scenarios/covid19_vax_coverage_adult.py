"""For ETL of the COVID 19 vaccination adult coverage data"""
...
# import schema
from ...datasets.scenarios.schemas.covid19_vax_coverage_adult import (
    extract_schema,
    load_schema,
)
from ..utils import get_timestamp, transform_template_lookup

config = datacat.scenarios.covid19_vax_coverage_adult
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="COVID 19 adult vaccination coverage data etl pipeline",
    )
